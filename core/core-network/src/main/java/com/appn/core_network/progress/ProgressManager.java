 ...
 */
package com.appn.core_network.progress;
...
import com.appn.core_network.progress.body.ProgressInfo;
import com.appn.core_network.progress.body.ProgressRequestBody;
import com.appn.core_network.progress.body.ProgressResponseBody;
...
public final class ProgressManager {
    private final Map<String, List<ProgressListener>> mRequestListeners = new HashMap<>();
    private final Map<String, List<ProgressListener>> mResponseListeners = new HashMap<>();
...
//        Log.e("IUpdateHttpService", "wrapResponseBody: " + key);
//        for (Map.Entry<String, List<ProgressListener>> entry : mResponseListeners.entrySet()) {
//            Log.e("IUpdateHttpService", "ProgressListener: " + entry.getKey() + " " + entry.getValue().size());
//        }
